import { ActionRowBuilder, ButtonBuilder, ButtonStyle, CommandInteraction, EmbedBuilder, GuildMember, SlashCommandBuilder, PermissionFlagsBits } from "discord.js"
import ms from "ms"
...
export default {
  data: new SlashCommandBuilder().setName('giveaway')
