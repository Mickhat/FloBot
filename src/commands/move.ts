...
export default {
  ...
  async execute (interaction: CommandInteraction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription("Dieser Server wird leider geschlossen. Du willst weiterchatten? Wir ziehen um auf den neuen Server: https://discord.gg/65pXxkSE5g Komm doch einfach vorbei!")
      .setFooter({
