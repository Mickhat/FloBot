...
export default {
  ...
  async execute(interaction: ButtonInteraction): Promise<void> {
    await interaction.update({
      embeds: [
        new EmbedBuilder()
          .setTitle('Nutzer melden')
          .setDescription(
            'Dieser Bot enthält ein Melde-System. Dieses soll garantieren, dass Moderatoren schnell mitbekommen, wenn auf dem Server etwas passiert, was nicht in Ordnung ist. ' +
