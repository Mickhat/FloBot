import { ActionRowBuilder, ButtonBuilder, ButtonInteraction, ButtonStyle, CommandInteraction, EmbedBuilder, Interaction, Message } from 'discord.js'



export async function helpIntroduction(interaction: CommandInteraction) {
...
export async function mainHelpPage(interaction: ButtonInteraction) {
...
export async function secondPage(interaction: ButtonInteraction) {
    interaction.update({
        embeds: [
...
export async function thirdPage(interaction: ButtonInteraction) {
    interaction.update({
        embeds: [
...
export async function fourthPage(interaction: ButtonInteraction) {
    interaction.update({
        embeds: [
